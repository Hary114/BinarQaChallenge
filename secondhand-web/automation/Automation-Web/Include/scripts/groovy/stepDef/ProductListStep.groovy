...
class ProductListStep {
	...
	public void thereAreProductCards() {
		WebUI.callTestCase(findTestCase('Page Objects/Products/seeSingleProductCard'), [:], FailureHandling.STOP_ON_FAILURE)
	}

	@Then("There are Image of the products")
	public void thereAreImageOfTheProducts() {
		WebUI.callTestCase(findTestCase('Page Objects/Products/seeImgProduct'), [:], FailureHandling.STOP_ON_FAILURE)
	}

	@Then("There are Name of the products")
	public void thereAreNameOfTheProducts() {
		WebUI.callTestCase(findTestCase('Page Objects/Products/seeProductName'), [:], FailureHandling.STOP_ON_FAILURE)
	}

	@Then("There are Category of the products")
	public void thereAreCategoryOfTheProducts() {
		WebUI.callTestCase(findTestCase('Page Objects/Products/seeBtnKategoriSemua'), [:], FailureHandling.STOP_ON_FAILURE)
	}

	@Then("There are Price of the products")
	public void thereArePriceOfTheProducts() {
		WebUI.callTestCase(findTestCase('Page Objects/Products/seeProductPrice'), [:], FailureHandling.STOP_ON_FAILURE)
	}
}