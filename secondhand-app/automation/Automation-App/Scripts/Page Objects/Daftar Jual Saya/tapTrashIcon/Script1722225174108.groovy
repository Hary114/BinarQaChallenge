...
//Mobile.tap(findTestObject('Pages/Daftar Jual Saya/iconTrashCan'), 5)
...
List<MobileElement> iconTrashCan = driver.findElementsById("id.binar.fp.secondhand:id/btn_delete")
...
for (int i = 0; i < productNames.size(); i++) {
	...
	if (productNames.get(i).getText().equals(expectedName)) {
		// Click the "iconTrashCan" button for the matched product
		iconTrashCan.get(i).click()
		break
	}
}