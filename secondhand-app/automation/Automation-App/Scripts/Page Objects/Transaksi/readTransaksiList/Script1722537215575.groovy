...
String namaProduk = "//*[@resource-id = 'id.binar.fp.secondhand:id/rv_history']//*[@resource-id = 'id.binar.fp.secondhand:id/tv_product_name']"
String hargaProduk = "//*[@resource-id = 'id.binar.fp.secondhand:id/rv_history']//*[@resource-id = 'id.binar.fp.secondhand:id/tv_product_price']"
String hargaTawar = "//*[@resource-id = 'id.binar.fp.secondhand:id/rv_history']//*[@resource-id = 'id.binar.fp.secondhand:id/tv_product_bid']"
String subjectStatus = "//*[@resource-id = 'id.binar.fp.secondhand:id/rv_history']//*[@resource-id = 'id.binar.fp.secondhand:id/tv_product_status']"
String timeStamp = "//*[@resource-id = 'id.binar.fp.secondhand:id/rv_history']//*[@resource-id = 'id.binar.fp.secondhand:id/tv_product_time']"
