...
Feature: App Accept Offer
  ...
  @AAO001 @Positive
  Scenario: User wants to accept an offer for a product
    When User press on Terima button
    And User see "Yeay kamu berhasil mendapat harga yang sesuai" accept popup modal
