@App_Update_Status_Batalkan
Feature: App Update Status Batalkan
  To update the accepted offer for a product to canceled
  ...
  #Background: 
    ...
    #And User input Nama Produk field "Man T-Shirt Batalkan"
    ...
    #And User input "Man T-Shirt Batalkan" on the Search Product field
    #And The system displays a list of product related to "Man T-shirt Batalkan"
    #And User press on the product name "Man T-shirt Batalkan"
